 ...
 * Contato + mapa.
 *
 * A seção é clara, então o mapa do Google já combina sem inversão. Aplicamos
 * só uma leve dessaturação para ele não brigar com o bege da página — mapas
 * coloridos puxam a atenção para longe do endereço e do botão de rota.
 */
export function Contato() {
  return (
    <section id="contato" className="bg-sand text-cocoa">
      <div className="mx-auto grid max-w-7xl lg:grid-cols-2">
        ...
        <div className="px-5 py-24 sm:px-8 sm:py-32 lg:pr-16">
          <Reveal>
            ...
            <p className="mt-6 max-w-prose text-[17px] leading-relaxed text-cocoaSoft">
              Atendimento com hora marcada para que você tenha o tempo
              necessário. Chame no WhatsApp e combinamos o melhor horário.
            </p>
          </Reveal>
          ...
          <Reveal delay={100}>
            <div className="mt-12 space-y-8">
              <div className="flex gap-5">
                ...
                />
                <div>
                  <h3 className="brand-caps text-[10px] text-cocoaSoft">Endereço</h3>
              ...
              <div className="flex gap-5">
                ...
                <div className="w-full max-w-xs">
                  <h3 className="brand-caps text-[10px] text-cocoaSoft">
                    Horário
                  </h3>
                  <dl className="mt-3 space-y-2.5">
                    {site.horarios.map((h) => (
                      <div key={h.dias} className="flex justify-between gap-6">
                        <dt className="text-cocoaSoft">{h.dias}</dt>
                        <dd className="tabular-nums text-cocoa">{h.horas}</dd>
                      </div>
                    ))}
                  </dl>
                </div>
        ...
        <div className="relative min-h-[24rem] border-t border-sandLine lg:min-h-full lg:border-l lg:border-t-0">
          <iframe
            ...
            style={{ filter: 'grayscale(0.55) contrast(0.95) sepia(0.12)' }}
          />
          {/* Véu bege levíssimo, para o mapa assentar na paleta da página. */}
          <div
            className="pointer-events-none absolute inset-0 bg-sand/15"
            aria-hidden="true"
          />
        </div>
      </div>
